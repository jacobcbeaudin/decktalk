...
| [ffmpeg](https://ffmpeg.org/) | Run as a separate process to cut, mix, and analyze audio and video. The builds that static-ffmpeg fetches include libx264 and are therefore GPL builds. DeckTalk does not link against them. | GPL-2.0-or-later for those builds, and LGPL-2.1-or-later for ffmpeg itself |
