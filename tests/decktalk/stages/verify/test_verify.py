"""The verify stage over an assembled project: the measurements faked, and one synthetic film measured for real."""
...
from support.media_cards import FPS, PANEL_PERCENT, H, W
