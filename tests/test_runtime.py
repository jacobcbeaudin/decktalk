...
gets on its own. The instrumentation a command injects is `tests/test_probe.py`, and what the
scaffold's own pages do with the runtime is `tests/test_scaffold_data.py`.
