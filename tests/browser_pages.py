...
`tests/test_runtime.py` opens these pages the way a person does, with decktalk-runtime.js and
nothing else. `tests/test_probe.py` opens them the way a DeckTalk command does, with
