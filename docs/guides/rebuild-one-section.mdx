...
<Frame caption="After an edit to section 3, only section 3 is voiced again, and --only 3 records only section 3.">
  <img className="block dark:hidden" src="/images/rebuild-lanes-light.svg" alt="Six section columns cross three lanes above an assemble bar. Section 4 is a clip and is hatched in every lane. In the narrate lane, section 3 reads voiced and the others read cached. A plain build records every page section. With --only 3, section 3 reads recorded and the others read kept. The assemble bar spans all six sections." />
  <img className="hidden dark:block" src="/images/rebuild-lanes-dark.svg" alt="Six section columns cross three lanes above an assemble bar. Section 4 is a clip and is hatched in every lane. In the narrate lane, section 3 reads voiced and the others read cached. A plain build records every page section. With --only 3, section 3 reads recorded and the others read kept. The assemble bar spans all six sections." />
</Frame>
