...
<div class="code" data-cue="7.1b" data-reveal="fade">decktalk build</div>
<p class="answer" data-cue="7.1c" data-reveal="pop">2x</p>
```
...
```js deck/index.html
DeckTalk.scene(1, { name: "Open", camera: "push", slides: [
