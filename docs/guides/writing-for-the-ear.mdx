...
that names the visual. "Picture that function as a loss surface" cues on `loss surface` and lands on
...
a concrete referent: `loss surface`, `Pick a point`, `learning rate`, `Change one sentence`,
`Edit the words`.
...
---------------------------------------------------------------------
 ...
 3  gradient-descent         118   0:51    0:20    1:00  -
 4  the-edit                  42   0:18    --      0:21  -
 5  close                     23   0:10    --      0:12  -
---------------------------------------------------------------------
    total                    305   2:11            2:30
```

The `target` column is the budget's length. Section 3 has a budget of twenty seconds,
from 0:40 to 1:00, and the silent rehearsal runs to a full minute. That gap is the signal to
