...
---------------------------------------------------------------------
 1  open                      29   0:12    --      --    -
 2  how-it-works              39   0:17    --      --    -
 3  how-ai-learns            228   1:38    1:00    --    -
 5  the-edit                  56   0:24    --      --    -
 6  close                     25   0:11    --      --    -
---------------------------------------------------------------------
    total                    377   2:42            --
...
- `est` paces the words at `words_per_minute` (140). Section 3 estimates 1:38, so it runs past its budget.
- `actual` fills in after a voiced build.

If `est` is longer than `target`, delete a sentence. Widen the budget only after a voiced build fills the `actual` column. Section 4 has no row, because a clip section has no script to voice.
