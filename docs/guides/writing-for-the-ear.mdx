...
The scaffold's lesson puts a beat before each slide size, so each path starts as its own event:

```md script.md
[pause 1] One setting makes every slide longer or shorter. [beat]
