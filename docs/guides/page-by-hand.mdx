...
<meta charset="utf-8">
<style>
  html, body { margin: 0; background: #15110e; color: #f5eee4; font: 44px/1.3 Inter, sans-serif; }
  ...
  .block { margin-top: 40px; width: 1200px; height: 220px; border-radius: 24px; background: #fbf6ee; }
</style>
<div id="stage">
