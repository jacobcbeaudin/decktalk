...
| `decktalk preflight` | an unfilled placeholder, `UNRESOLVED`, `UNKNOWN CUE`, `NO CHANGE`, and `POP AT CUT` in frozen frames, before any recording | motion, timing, and every check on the final mp4 |
