...
Recording runs in real time, one section after another. A first silent build of the scaffold took 236.6 seconds on a MacBook Pro with Apple M5 Pro and 64 GB memory. The video it made is 216.72 seconds long.
