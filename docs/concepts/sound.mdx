...
<Frame caption="The underscore rises as the speech of section 3 ends, then stays down under the clip.">
  <img className="block dark:hidden" src="/images/duck-lane-light.svg" alt="The underscore level around clip section 4, from 2:48 to 2:59 of the video. It sits at −30 dB under each spoken span and under the whole clip. It ramps up to −24 dB over the last 0.5 s of speech in section 3, and briefly at the cut into section 5." />
  <img className="hidden dark:block" src="/images/duck-lane-dark.svg" alt="The underscore level around clip section 4, from 2:48 to 2:59 of the video. It sits at −30 dB under each spoken span and under the whole clip. It ramps up to −24 dB over the last 0.5 s of speech in section 3, and briefly at the cut into section 5." />
</Frame>
