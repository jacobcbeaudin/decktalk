...
<Frame caption="The underscore rises as the speech of section 4 ends, then stays down under the clip.">
  <img className="block dark:hidden" src="/images/duck-lane-light.svg" alt="The underscore level around clip section 5, from 3:14 to 3:25 of the video. It sits at −30 dB under each spoken span and under the whole clip. It ramps up to −24 dB over the last 0.5 s of speech in section 4, and briefly at the cut into section 6." />
  <img className="hidden dark:block" src="/images/duck-lane-dark.svg" alt="The underscore level around clip section 5, from 3:14 to 3:25 of the video. It sits at −30 dB under each spoken span and under the whole clip. It ramps up to −24 dB over the last 0.5 s of speech in section 4, and briefly at the cut into section 6." />
</Frame>
