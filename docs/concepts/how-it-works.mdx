...
<Frame caption="The script, the voice, the cues, the slides and the video, and the file each one is. The cues are the join.">
...
{/* sample: decktalk build --no-voice, build without voice of the starter, the narrate lines */}
```text
