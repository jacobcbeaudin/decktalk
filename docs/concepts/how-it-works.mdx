...
|---|---|---|
| `narrate` | `narrate` voices each section and gets a time for every word. | `build/narration/<hash>.mp3`, `<hash>.words.json`, `takes.json`, `narration.mp3`, `timeline.json` |
...
```text
[sil ] 01  29 words -> 17.10s (estimated words)
[sil ] 02  40 words -> 20.80s (estimated words)
[sil ] 03  285 words -> 142.50s (estimated words)
```
