...
The verify stage inside `decktalk build` checks section starts and cuts, and cut continuity for a section that sets `carries_previous`. `decktalk verify` also checks the cues.
