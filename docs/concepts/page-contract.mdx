...
that instant. Without `t0=signal`, the page starts its clock at `load` plus the `t0`
...
| Headlines | Headlines run from 64 px to 120 px. The scaffold's hero is 120 px and its titles are 64 px. |
