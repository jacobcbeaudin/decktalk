...
| Freeze mode | `frozen` | `?step=ID`, optionally with `&cue=CUE` | One step mounts with its reveals in their end state. `decktalk shots` and `decktalk preflight` use this mode. |
