...
{/* sample: decktalk beats, silent build of the scaffold with cue id 5.1cap removed from the page, trimmed to section 5 */}
```text
sec  speech   need  cues
...
{/* sample: decktalk beats, silent build of a fresh scaffold with a typo in the 3.4name phrase, trimmed to section 3 */}
```text
sec  speech   need  cues
