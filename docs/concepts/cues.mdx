...
scaffold's script says "decktalk dot AI", and its slide shows decktalk.ai. So the cue `5.1url`
uses the phrase "decktalk dot AI". A number written in digits comes back in the form the voice
