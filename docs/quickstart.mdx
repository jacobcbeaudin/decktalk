...
<Steps>
  ...
  <Step title="Scaffold and build">
    ...
    The scaffold is a short lesson in five sections: a title, three labeled lines, a
    derivation that reveals line by line, a prompt before-and-after, and a closing card. All
    five are page sections, which DeckTalk records from `deck/index.html` and cuts to the narration. A
