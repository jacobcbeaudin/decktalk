...
<Steps>
  ...
  <Step title="Scaffold and build">
    ...
    The scaffold is a short lesson in five sections: a title whose subtitle follows the
    voice word by word, three labeled lines, a gradient descent lesson in which a loss bowl
    draws and a point steps down it, a query-review prompt before and after, and a closing
    recap with an end card. All five are page sections, which DeckTalk records from
