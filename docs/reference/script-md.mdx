...
ends, puts the lead before the take, cuts the take there, and places exactly the tail after that sound, so a
pause or a breath the voice left after its last sound never plays. The lead and the tail depend on the take and on the
