...
|---|---|---|
| Before the first spoken section | `opening_silence_seconds` | 0.7 |
...
ffmpeg adds this silence to the audio. The speech provider does not receive it. `lead_seconds` goes into
...
section span          = section length + lead_seconds
```
