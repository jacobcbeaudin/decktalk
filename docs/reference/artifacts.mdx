...
```json
{
  ...
  "05": "5.1cap@2.46,5.1made@5.4,5.1docs@7.37"
}
```
...
```json
{
  "01": { "1.1curve": 1.14, "1.1number": 2.92, "1.1mark": 3.81, "1.1cap": 20.23 }
}
```
...
```json
{
  "url": "file:///home/me/my-lesson/deck/index.html?scene=1&beats=1.1curve%401.14%2C1.1number%402.92&words=The%400.00%2Ccurve%401.14&t0=signal",
  "requested_seconds": 22.8,
