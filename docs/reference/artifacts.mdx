...
| `input_hash` | string | The digest of the page URL, the frame geometry and the content of the page and of every file in `assets`. `record` skips a section whose hash has not moved. |
