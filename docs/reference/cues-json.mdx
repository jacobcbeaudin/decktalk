...
```json cues.json
{
  "sections": {
    "8": {
      "cues": [
        { "cue": "7.1box", "on": "box" },
        { "cue": "7.1moved", "on": "moved" },
        { "cue": "7.1checked", "on": "checked" },
        { "cue": "7.1back", "on": "step back" }
      ]
    },
    "9": {
      "cues": [
...
Section 8 of the scaffold plays scene 7 of its page, so its cue ids start with `7.1`. Section 9 plays
...
| `occurrence` | integer | `1` | Which match of the phrase to use. When the phrase occurs more than once and this key is not set, `beats` warns. |
