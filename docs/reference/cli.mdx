...
sec   cut at  before cut  result
 ...
 03   144.67   -126.0 dB  quiet
 04   166.09   -125.4 dB  quiet
 05   175.53   -120.0 dB  quiet

check                 cue       at   chg %   ctl %   offset     a/v  result
3:3.1p1             41.55    98.27    0.42    0.00    +50ms   +66ms  changed
3:3.1eq             43.99   100.71    0.36    0.00    +50ms   +62ms  changed
...
5:5.1cap             2.84   168.92    0.31    0.00    -40ms   -66ms  changed
```
...
cues     cues.json  ok
  ...
  3  Gradient descent          0:57    2:25    88.0
  4  The edit                  2:25    2:46    21.4
  5  Close                     2:46    2:56     9.4
     narration total 2:56  (estimated: silent placeholders)
beats    5 section(s) with resolved cues
final    build/out/my-lesson.mp4  2:58
