...
- A section can play a scene with another number. After [Add a clip section](/guides/clip-section), section 5 plays scene 4.
...
decktalk verify 1:1.1bowl --cue 5:5.1cap    # only these two cues
