...
Note: the lesson example also says "error", for how wrong a guess is. That word is lesson content, not a DeckTalk term. [What does the lesson mean by error?](/help/faq#what-does-the-lesson-mean-by-error) gives the precise meaning.
