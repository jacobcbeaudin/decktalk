...
|---|---|---|
| build | One run of `decktalk build` through all seven stages. A *plain build* has no `--only`. | [How it works](/concepts/how-it-works) |
...
| words file | `build/narration/NN-slug.words.json`. | [Build artifacts](/reference/artifacts) |
