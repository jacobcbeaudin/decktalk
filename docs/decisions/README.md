...
One note per choice that the code cannot explain by itself. Each says what was decided, what it
...
| [Seven stages became five](seven-stages-to-five.md) | Why `measure` and `check` do not exist |
| [A speech provider is a two-method protocol](the-provider-interface.md) | What DeckTalk needs from a voice, and what it refuses to need |
