...
- A silent build stops when the project has voiced takes, because it would empty the narration cache. [Rebuild one section](/guides/rebuild-one-section#a-silent-build-and-a-voiced-build) explains the cache.
